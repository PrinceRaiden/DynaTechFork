...
public class Orechid extends AMachine implements RecipeDisplayItem {
    ...
    private static void registerDefaultOres() {
        registerOre(Material.STONE, Material.COAL_ORE, 40);
        registerOre(Material.STONE, Material.IRON_ORE, 1);
        registerOre(Material.STONE, Material.GOLD_ORE, 1);
        registerOre(Material.STONE, Material.DIAMOND_ORE, 1);
        registerOre(Material.STONE, Material.EMERALD_ORE, 1);
        registerOre(Material.STONE, Material.REDSTONE_ORE, 1);
        registerOre(Material.STONE, Material.LAPIS_ORE, 1);
        registerOre(Material.STONE, Material.COPPER_ORE, 1);
